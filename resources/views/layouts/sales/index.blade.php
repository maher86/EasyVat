...
<section class="content" style="background-color:#fff">
        <div class="row">
            <div class="col-md-12" style="margin:0px 20px 0px 20px;">
                <h3 style="float:left;margin:40px">Sales Invoices</h3>
                <a href="{{route('SalesTrans.create')}}"class="btn btn-primary" style="float:right;margin:40px;"><i class="fas fa-plus" style="margin-right:3px"></i>create Sales Invoice</a>
            </div>
        </div>
